...
//#endregion
  ...
  onSubmit(){
    ...
    if (this.allTabsValid()){
      this.mapProperty();
      this.housingServices.addNewProperty(this.property);
      this.alert.success('Congrats, Form has been submitted');
    ...
    this.alert.error('Somthing wrong, Please review the form');
  }
  }
